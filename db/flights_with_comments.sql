...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2014 at 09:18 PM
...
-- Database: `flights`
--
CREATE DATABASE `flights` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci; --краще кодування utf8_general_ci. З юнікодом можуть бути проблеми із кирилицею
USE `flights`;
...
CREATE TABLE IF NOT EXISTS `address` ( --addresses --тут же декілька адрес буде, а не одна, правда ? :)
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `Country` varchar(10) COLLATE utf8_unicode_ci NOT NULL, --country_id --з маленької літери і всі країни взагалі варто винести в окрему таблицю
  ...
  `zip-code` int(8) NOT NULL, -- через дефіс не варто називати поле, краще нижнє підкреслення використати
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
...
--
-- Table structure for table `aviacompany`
--

CREATE TABLE IF NOT EXISTS `aviacompany` ( --теж множина мала б бути
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_name` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `foundation_year` year(4) NOT NULL,
  `companyPresident_name_surname` varchar(25) COLLATE utf8_unicode_ci NOT NULL, --варто простіше назвати :) тобі ж ці поля потім в запитах писати --і можливо, варто винести в окрему таблицю persons усіх президентів компаній і мерів міст
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `cities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `city_name` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `country` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `residents_amount` int(10) NOT NULL,
  `mayor_name_surname` varchar(20) COLLATE utf8_unicode_ci NOT NULL, --як і в попередній таблиці name_surname варто прибрати
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `flight` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `flight_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `company_name` varchar(20) COLLATE utf8_unicode_ci NOT NULL, --company_id
  `departure_city` varchar(15) COLLATE utf8_unicode_ci NOT NULL, --city_id і звязок із таблицею міст
  `arrival_city` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `ticket_price` int(5) NOT NULL,
  `departure_time` time NOT NULL,
  `aircraft_brand` varchar(10) COLLATE utf8_unicode_ci NOT NULL, -- також для нормалізації варто винести в окрему таблицю
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `address_ibfk_1` FOREIGN KEY (`id`) REFERENCES `aviacompany` (`id`);

--
-- Constraints for table `aviacompany`
--
ALTER TABLE `aviacompany`
  ADD CONSTRAINT `aviacompany_ibfk_1` FOREIGN KEY (`id`) REFERENCES `address` (`id`);
--
...
('def', 'flights', 'address', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'flights', 'address', 'Country', 2, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'address', 'city', 3, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'address', 'street', 4, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'address', 'house_number', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'address', 'zip-code', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(8)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'aviacompany', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'flights', 'aviacompany', 'company_name', 2, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'aviacompany', 'foundation_year', 3, NULL, 'NO', 'year', NULL, NULL, NULL, NULL, NULL, NULL, 'year(4)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'aviacompany', 'companyPresident_name_surname', 4, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'cities', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'flights', 'cities', 'city_name', 2, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'cities', 'country', 3, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'cities', 'residents_amount', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'cities', 'mayor_name_surname', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'flight_name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'company_name', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'departure_city', 4, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'arrival_city', 5, NULL, 'NO', 'varchar', 15, 45, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'ticket_price', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'departure_time', 7, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
('def', 'flights', 'flight', 'aircraft_brand', 8, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '247'),
('HANDLER_READ_KEY', '66'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '0'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '4'),
('HANDLER_READ_RND_NEXT', '5975'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '4'),
('HANDLER_WRITE', '5407'),
('INNODB_BUFFER_POOL_PAGES_DATA', '172'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '127'),
('INNODB_BUFFER_POOL_PAGES_FREE', '8019'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3029'),
('INNODB_BUFFER_POOL_READS', '147'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '585'),
('INNODB_DATA_FSYNCS', '48'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6688768'),
('INNODB_DATA_READS', '286'),
('INNODB_DATA_WRITES', '167'),
('INNODB_DATA_WRITTEN', '4214272'),
('INNODB_DBLWR_PAGES_WRITTEN', '127'),
('INNODB_DBLWR_WRITES', '9'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '87'),
('INNODB_LOG_WRITES', '17'),
('INNODB_OS_LOG_FSYNCS', '30'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '46080'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '26'),
('INNODB_PAGES_READ', '146'),
('INNODB_PAGES_WRITTEN', '127'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '11690'),
('UPTIME_SINCE_FLUSH_STATUS', '11690');
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Sanya-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Sanya-PC.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\Sanya-PC.err'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Sanya-PC-slow.log'),
...
('def', 'flights', 'PRIMARY', 'def', 'flights', 'address', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'flights', 'address_ibfk_1', 'def', 'flights', 'address', 'id', 1, 1, 'flights', 'aviacompany', 'id'),
('def', 'flights', 'PRIMARY', 'def', 'flights', 'aviacompany', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'flights', 'aviacompany_ibfk_1', 'def', 'flights', 'aviacompany', 'id', 1, 1, 'flights', 'address', 'id'),
('def', 'flights', 'PRIMARY', 'def', 'flights', 'cities', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'flights', 'PRIMARY', 'def', 'flights', 'flight', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-02-16 19:18:15', '2014-02-16 19:18:15', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2014-02-16 19:18:15', NULL, NULL, NULL, '', '', NULL),
('def', 'flights', 'address', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2014-02-16 19:06:55', NULL, NULL, NULL, '', '', NULL),
('def', 'flights', 'aviacompany', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2014-02-16 19:01:47', NULL, NULL, NULL, '', '', NULL),
('def', 'flights', 'cities', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2014-02-16 18:50:48', NULL, NULL, NULL, '', '', NULL),
('def', 'flights', 'flight', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2014-02-16 18:19:22', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:08', '2012-05-15 12:23:07', NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 120, 120, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2014-02-16 19:16:36', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-13 08:46:49', NULL, NULL, '', '', NULL);
...
(240, 'root', 'localhost:53599', 'flights', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(239, 'root', 'localhost:53598', NULL, 'Sleep', 2, '', NULL);
...
('def', 'flights', 'address_ibfk_1', 'def', 'flights', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'address', 'aviacompany'),
('def', 'flights', 'aviacompany_ibfk_1', 'def', 'flights', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'aviacompany', 'address');
...
('def', 'flights', 'utf8', 'utf8_unicode_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3134'),
('INNODB_BUFFER_POOL_READS', '147'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '585'),
('INNODB_DATA_FSYNCS', '48'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '11692'),
('UPTIME_SINCE_FLUSH_STATUS', '11692');
...
('def', 'flights', 'address', 0, 'flights', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flights', 'address', 1, 'flights', 'id', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flights', 'aviacompany', 0, 'flights', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flights', 'cities', 0, 'flights', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'flights', 'flight', 0, 'flights', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-02-16 19:18:16', '2014-02-16 19:18:16', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2014-02-16 19:18:16', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'flights', 'address', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 9437184, 1, '2014-02-16 19:06:55', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'flights', 'aviacompany', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2014-02-16 19:01:47', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'flights', 'cities', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2014-02-16 18:50:48', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'flights', 'flight', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2014-02-16 18:19:22', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:08', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 120, 120, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2014-02-16 19:16:36', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-13 08:46:49', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('def', 'flights', 'PRIMARY', 'flights', 'address', 'PRIMARY KEY'),
('def', 'flights', 'address_ibfk_1', 'flights', 'address', 'FOREIGN KEY'),
('def', 'flights', 'PRIMARY', 'flights', 'aviacompany', 'PRIMARY KEY'),
('def', 'flights', 'aviacompany_ibfk_1', 'flights', 'aviacompany', 'FOREIGN KEY'),
('def', 'flights', 'PRIMARY', 'flights', 'cities', 'PRIMARY KEY'),
('def', 'flights', 'PRIMARY', 'flights', 'flight', 'PRIMARY KEY'),
...
('root', '[{"db":"flights","table":"address"},{"db":"flights","table":"aviacompany"},{"db":"flights","table":"flight"}]');
